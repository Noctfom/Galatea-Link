...
3. 当前动态观察，包括资源、公开卡片、已知信息、连锁、历史、合法动作、可选 Core 建议和 `runtime_controls`
...
当前输入已经覆盖基础动作语义、公开素材、常见卡片关系、可缓存卡组知识和受控自主介入，但仍不足以保证复杂竞技决策始终有效。下一阶段应继续补齐状态标记、持续效果和效果历史，并把外部平台对话纳入独立的上下文管理层
